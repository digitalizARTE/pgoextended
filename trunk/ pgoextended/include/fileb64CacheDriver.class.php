 ...
 * @version 1.0
 */
class FileCacheDriverB64 implements CacheDriver
{
	...
	public function __construct( $dir = null )
	{
		...
		else if( !$this->checkDirectory( $this->dir ) ) 
		{
	...
	{
		if( !$this->checkDirectory( $this->createPath( $groupName ) ) ) 
		{
			return false;
		}
		return file_put_contents( $this->createPath( $groupName, $identifier ), base64_encode( $data ) ) === false ? false : true;
	}
	...
	{
		return base64_decode( file_get_contents( $this->createPath( $groupName, $identifier ) ) );
	}
	...
	{
		if( !is_dir( $dir ) && mkdir( $dir, 0777 )==false ) 
		{
			return false;
		}
