...
// necessary classes
require_once('class._soapclient.php');
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (_soapclient->response has contents of the response)");
			return false;
		}
...
/**
*
* _soapclient higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $_soapclient = new _soapclient( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $_soapclient->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($_soapclient);
*
...
* @access   public
*/
class _soapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function _soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends _soapclient {
	'.$evalStr.'
}';
		return $evalStr;
	}
