...
//$server = new SoapServer(null, array('uri' =>'http://127.0.0.1:8080/pog3.0d/services/'));
//$server = new SoapServer(null, array('uri' =>'http://127.0.0.1:8080/pog3.0d/services/'));
$server = new SoapServer('pog.wsdl', array('uri' =>'http://127.0.0.1:8080/pog3.0d/services/'));
