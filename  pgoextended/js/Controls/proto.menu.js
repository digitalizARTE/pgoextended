 ...
 * @author        Eiff Damian - damian@digitalizarte.com.ar
 * @version       0.7
 * @date          12/03/07
 * @date          2008-11-16
...
Proto.Menu = Class.create({
	initialize: function() {
		...
		this.options = Object.extend({
			...
			beforeHide: e,
			beforeSelect: e,
            rightclick: true, // Modificado para poder deshabilitar el click derecho 
            leftclick: false // Modificado para poder utilizar click izquierdo            
		}, arguments[0] || { });
        ...
        if( this.options.rightclick || Prototype.Browser.Opera )
        {
        ...
        if( this.options.leftclick && ! Prototype.Browser.Opera )
        {
            $$(this.options.selector).invoke('observe', 'click' , function(e){ this.show(e); }.bind(this));
        }
