...
class ObjectMap
{
	...
	function CreateConstructor()
	{
        ...
        $this->string .= "\n\t\n\tfunction __construct (\$".$this->object1."Id = '', \$".strtolower($this->object2)."Id = '')";
	...
	function CreateAddMappingFunction()
	{
		...
		$this->string .= "\n\t\tif (\$object instanceof ".$this->object1." && \$object->".strtolower($this->object1)."Id != '')";
		$this->string .= "\n\t\t{";
		...
		$this->string .= "\n\t\t\treturn \$this->Save();";
		$this->string .= "\n\t\t}";
		$this->string .= "\n\t\telse if (\$object instanceof ".$this->object2." && \$object->".strtolower($this->object2)."Id != '')";
		$this->string .= "\n\t\t{";
