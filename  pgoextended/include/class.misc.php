...
class Misc
{
	...
	function TypeIsKnown($type)
	{
        ...
        || $type=="VARCHAR(150)"	//mysql
		|| $type=="VARCHAR(100)"	//mysql
		|| $type=="VARCHAR(50)"	//mysql
		|| $type=="VARCHAR(30)"	//mysql
		|| $type=="VARCHAR(20)"	//mysql
        || $type=="VARCHAR(10)"	//mysql
        || $type=="VARCHAR(5)"	//mysql
        || $type=="VARCHAR(3)"	//mysql
        || $type=="VARCHAR(2)"	//mysql
        || $type=="VARCHAR(1)"	//mysql
		|| $type=="TINYINT"
		|| $type=="TEXT"
		|| $type=="INT"
		|| $type=="DATE"
