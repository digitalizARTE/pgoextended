 ...
 * @version 1.0
 */
class FileGzCacheDriver implements CacheDriver
{
	...
	public function set( $groupName, $identifier, $data )
	{
		...
		return file_put_contents( $this->createPath( $groupName, $identifier ),  gzdeflate ( $data, 9 ) ) === false ? false:true;
	}
	...
	{
		return  gzinflate ( file_get_contents( $this->createPath( $groupName, $identifier ) ) );
	}
